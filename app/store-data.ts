...
export const defaultProducts: StoreProduct[] = [
  ...
  { id: "mvla-bege", name: "MVLA Essencial Bege", message: "Família, fé e propósito", price: 99.9, category: "Unissex", sizes: ["P", "M", "G", "GG"], colors: [{ name: "Bege", hex: "#D8C3A3", image: "/store/mvla-bege.png" }] },
];
