...
export default async function Home() {
  ...
  return <main className="institutional">
    <SiteHeader />
    <section id="inicio" className="person-hero shell"><div className="orbit" /><div className="orbit orbit-two" /><div className="person-copy"><p className="eyebrow"><span /> {content.hero.eyebrow}</p><h1><span>Matheus Vidal</span><br />{content.hero.title}</h1><p>{content.hero.description}</p><div className="actions"><a className="primary" href="#contato">Consultar agenda e convites <span>→</span></a><a className="text-link" href="#sobre">Conheça minha história <span>↓</span></a></div></div><div className="person-photo"><div className="orange-halo" /><Image src={content.hero.image} fill sizes="(max-width: 850px) 100vw, 46vw" alt="Matheus Vidal, pregador da Palavra" priority unoptimized /><p>{content.hero.caption}</p></div></section>
